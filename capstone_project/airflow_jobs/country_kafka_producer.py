...
KAFKA_TOPIC_NAME_CONS = "covid19country"
...
if __name__ == "__main__":
    ...
    for data in get_data:
        ...
        dict_data["id"] = i
        dict_data["country"] = data["country"].replace("'", " ")
        dict_data["country_code"] = data["countryInfo"]["iso3"]
        ...
        dict_data["today_recovered"] = data["todayRecovered"]
